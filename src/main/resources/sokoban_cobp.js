    ...
    ctx.bthread( "box", 'Box.Any', function(b){
        ...
        while (true){
            ...
            let neighbors_list = find_adjacent_boxes(b.location, walls_list).concat(
                find_adjacent_boxes(b.location, ctx.runQuery('Box.Any')));
...
// }
/*bthread( "data", {box_list: box_list, player_location: player_location, str: "AI"+data_to_str(player_location, box_list)}, function() {
    let e = null;

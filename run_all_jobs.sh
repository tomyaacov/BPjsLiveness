...
#SBATCH --job-name run_all_jobs2 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_all_jobs2.out ### output log for running job - %J is the job number variable
...
files=("map_9_8_2" "map_11_9_2" "map_10_9_2" "map_9_9_2" )
